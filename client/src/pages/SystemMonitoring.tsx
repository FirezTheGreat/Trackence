      ...
      <section className="backdrop-blur-2xl bg-secondary/40 border border-white/10 rounded-3xl px-6 md:px-8 py-8 shadow-2xl shadow-black/20">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-white/10 text-white/90 bg-white/5 hover:bg-white/10 hover:border-white/20 hover:shadow-lg transition-all duration-300 font-medium tracking-wide"
            disabled={refreshing}
          >
