        ...
        <div className="flex-1 max-w-sm">
          ...
          {(["all", "active", "ended"] as const).map((filter) => (
            <button
              ...
              className={`px-2.5 sm:px-3 py-2 rounded-lg text-xs sm:text-sm transition cursor-pointer text-center ${sessionFilter === filter ? "bg-accent text-white" : "bg-white/10 text-white/60 hover:bg-white/20"}`}
            >
              {filter === "all" && "All"}
