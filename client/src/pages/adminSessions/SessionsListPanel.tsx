        ...
        <div className="flex gap-2">
          {(["all", "active", "ended"] as const).map((filter) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm transition cursor-pointer ${sessionFilter === filter ? "bg-accent text-white" : "bg-white/10 text-white/60 hover:bg-white/20"}`}
            >
              {filter === "all" && "All"}
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <div className="relative group">
                        ...
                        {qrTimeLeft[session.sessionId] !== undefined && (
                          <div className="absolute -bottom-1 -right-1 bg-[#ad431a] text-white text-[10px] font-bold px-1.5 py-0.5 rounded">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    {session.isActive && (
                      <button
                        ...
                        className="px-3 py-1 bg-red-500/20 border border-red-500/50 text-red-300 hover:bg-red-500/30 rounded-lg text-xs font-bold transition disabled:opacity-50 cursor-pointer"
                      >
                    ...
                    <button
                      ...
                      className="px-3 py-1 bg-blue-500/20 border border-blue-500/50 text-blue-300 hover:bg-blue-500/30 rounded-lg text-xs font-bold transition cursor-pointer"
                    >
                      ✏️ Edit
                    </button>
                    <button
