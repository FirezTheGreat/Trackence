            ...
            <div className="px-3 sm:px-6 md:px-16 pt-8 md:pt-10 pb-16">
                <div className="max-w-xl mx-auto rounded-2xl border border-red-500/30 bg-red-500/10 p-6 text-center">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-white/20 text-white hover:bg-white/10 transition-colors cursor-pointer"
                    >
                    ...
                    <div className="space-y-3">
                        {data.alerts.slice(0, 10).map((alert, index) => (
                            <div
                                ...
                                className={`rounded-xl border px-3 py-2 text-sm font-inter ${alert.severity === "critical"
